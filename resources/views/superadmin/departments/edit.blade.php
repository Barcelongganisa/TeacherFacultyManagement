...
@section('title', 'Edit Department - Super Admin')

@section('page-header')
    <div class="flex-between">
        <div>
            <h1><i class="fas fa-edit me-2"></i>Edit Department</h1>
            <p class="text-muted">Update details for {{ $department->name }}</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('superadmin.departments.show', $department->id) }}" class="btn btn-outline-info">
        ...
        <div class="col-lg-7">
            <div class="card">
                <div class="card-header">
                    <h5><i class="fas fa-pen me-2"></i>Department Information</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('superadmin.departments.update', $department->id) }}" method="POST">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('superadmin.departments.show', $department->id) }}" class="btn btn-outline-secondary">
