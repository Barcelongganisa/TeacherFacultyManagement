...
<head>
    ...
    <style>
        ...
        .card-header h5 i { color: var(--primary-green); }
        ...
        .badge.bg-green    { background: var(--primary-green) !important; color: white; }
        ...
        .form-control:focus, .form-select:focus {
            ...
            box-shadow: 0 0 0 0.2rem rgba(26, 122, 60, 0.25);
        }
        ...
        .page-header h1 i { color: var(--primary-green); }
        .page-header p { color: var(--text-soft); margin-bottom: 0; }
